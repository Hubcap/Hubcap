...
class AppDelegate
    ...
    #
    # Returns the directory the application uses to store the Core Data store file. This code uses a directory named "Hubcap" in the user's Library directory.
    #
    ...
    def persistentStoreCoordinator
        ...
        url = directory.URLByAppendingPathComponent("Hubcap.storedata")
